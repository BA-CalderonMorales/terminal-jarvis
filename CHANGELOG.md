...
### Changed
- **Dead Code Cleanup**: Removed the unused future remote API framework and its direct HTTP client dependency to keep the shipped library surface focused on active behavior.
