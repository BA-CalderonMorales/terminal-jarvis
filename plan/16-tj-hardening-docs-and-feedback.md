...
- User evaluating Terminal Jarvis through static, Killercoda, Codespaces, or hosted demo.
...
- [ ] Run command/link/asset/version checks against docs and external showcase sources.
...
- [ ] `DOC-01` Install and first-run instructions are verified for every supported channel.
...
- [ ] `DOC-08` Commands, links, versions, assets, and external scenario content pass drift checks.
...
reviews pass and docs-only CI is explicitly dispatched.
