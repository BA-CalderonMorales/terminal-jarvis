...
fn compose_puts_the_given_hint_below_the_prompt_with_the_indicator() {
    ...
    assert_eq!(
        ...
        "[>_]::[tj:0.1.16]::[harness:codex]: \nactive: codex | list, home, exit\x1b[1A\r[>_]::[tj:0.1.16]::[harness:codex]: "
    );
...
fn compose_stays_plain_without_ansi() {
    ...
    assert_eq!(
        ...
        "[>_]::[tj:0.1.16]::[harness:codex]: pick a number\n[>_]::[tj:0.1.16]::[harness:codex]: "
    );
    crate::cli::style::restore(previous);
}
...
fn indicator_marks_harness_and_debug_and_survives_roundtrips() {
    ...
    assert_eq!(plain.raw(), "[>_]::[tj:0.1.16]::[harness:none]::[debug]:");
    assert_eq!(
        plain.render(false),
        "[>_]::[tj:0.1.16]::[harness:none]::[debug]: "
    );
    crate::cli::style::restore(previous);
}
...
fn retire_clears_the_box_and_keeps_the_committed_line_above() {
    ...
    assert_eq!(
        ...
        "\r\x1b[2K[>_]::[tj:0.1.16]::[harness:codex]: "
    );
    assert_eq!(
