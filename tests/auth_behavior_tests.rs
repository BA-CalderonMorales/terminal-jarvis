...
fn print_help() {
    ...
    println!("    - test_auth_state_persistence            Tests auth state across tool invocations");
    println!("    - test_env_cleanup                       Tests environment variable cleanup");
    println!();
    println!("  Cross-Platform Tests:");
    println!("    - test_cross_platform_auth_behavior      Tests auth behavior across different OS");
