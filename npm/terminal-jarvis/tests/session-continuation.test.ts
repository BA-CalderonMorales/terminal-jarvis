...
describe('Session Continuation Support', () => {
  ...
  describe('Tool Listing for Session Management', () => {
    test('list command shows supported tools', async () => {
      ...
      // Should show some AI coding tools
      // Using flexible matching since tool names may vary
      const hasToolInfo = 
        ...
        output.toLowerCase().includes('gemini');
